...
<div class="block-30 block-30-sm item" style="background-image: url('<?php echo base_url() . 'assets/vendors/images/dribbble.jpg' ?>');" data-stellar-background-ratio="0.5">
    <div class="container">
...
<header class="clearfix">
    <div class="container">
        ...
        <div class="company-address">
            <h2 class="title">Invoice Pemesanan Paket Tour</h2>
            <p>
                84454, Sumbawa<br>
                AZ 85004, ID
            </p>
        ...
        <div class="company-contact">
            <div class="phone left">
                ...
                <a href="tel:602-519-0450">(+62) 519-0450</a>
            ...
            <table class="grand-total">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="total"><?php echo 'Rp. ' . number_format($b['total']); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<footer>
    <div class="container">
        <div class="thanks">Terimah Kasih Telah Mempercayakan Kami Sebagai Teman Wisata Anda</div>
        <div class="notice">
            <div>NOTICE:</div>
            <div>Pembatalan Tiket Hanya Bisa 3 Hari sebelum <?php echo $b['berangkat']; ?></div>
            <br>
            <br>
            <div>
                <p>
