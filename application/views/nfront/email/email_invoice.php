            ...
            <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        <tr>
                            <td class="free-text">
                                Terimah kasih telah melakukan order paket tour wista. Mohon segera melakukan konfirmasi pembayaran dengan mengklik tombol Komfirmasi dibawah ini.
                            </td>
                        </tr>
                        <tr>
                            <td class="button">
              ...
              <![endif]--><a href="<?= base_url('konfirmasi'); ?>" style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Konfirmasi</a></div>
                            </td>
                        </tr>
                        <tr>
                            <td class="w320">
                                                ...
                                                <tr>
                                                    <td class="mini-block-padding">
                                                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                                            <tr>
                                                                <td class="mini-block">
                                                                    <span class="header-sm">Data Pesan Tiket</span><br />
                                                                    <b>Paket:</b>
                                                                    <?php echo $b['nama_paket']; ?>\<br />
                                                                    Metode Pembayaran: <?php echo $b['metode'] ?> <br />
                                                                    <b>Bank:</b>
                                                                    <?php echo $b['bank'] ?> <br />
                                                                    <b>No Rekening:</b>
                                                                    <?php echo $b['norek'] ?> <br />
                                                                    <b>Atas Nama:</b>
                                                                    <?php echo $b['atasnama'] ?> <br />
                                                                    <b>Jumlah Transfer:</b>
                                                                    <b><?php echo 'Rp. ' . number_format($b['total']); ?></b> <br />
                                                                    <b>Total Berangkat:</b>
                                                                    <?php echo $b['jml_berangkat'] . ' Orang'; ?> <br />
                                                ...
                                                <tr>
                                                    <td class="mini-block-padding">
                                                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                                            <tr>
                                                                <td class="mini-block">
                                                                    <span class="header-sm">Nama Pemesan</span> <br />
                                                                    <?php echo $b['nama'] ?><br />
                            ...
                            <td class="item-table">
                                <table cellspacing="0" cellpadding="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-col">
                                            <?php echo 'Rp. ' . number_format($b['total']); ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                            ...
                                            <span class="total-space" style="font-weight:bold; color: #4d4d4d"> <?php echo 'Rp. ' . number_format($b['total']); ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        <tr>
                            <td style="padding: 25px 0 25px">
                                <strong>Sumbawa Tour</strong><br />
                                Jln. Lintas Seteluk Poto Tano <br />
                                Indonesia <br /><br />
                            </td>
                        </tr>
                    </table>
