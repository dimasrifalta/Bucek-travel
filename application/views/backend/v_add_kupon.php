        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">Post</a></li>
                    <li class="active">Add Kupon Diskon</li>
                </ol>
            </section>
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nama Paket Tour</h3>
                    </div>

                    <form action="<?php echo base_url() . 'backend/post/simpan_post_kupon' ?>" method="post" enctype="multipart/form-data">

                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <select name="id_paket" id="paket" data-width="100%" class="form-control" required>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-flat pull-right"><span class="fa fa-upload"></span> Add Kupon</button>
                                        <!-- /.form-group -->
                                    </div>
                                    <!-- /.col -->
                                </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="box box-danger">
                            <div class="box-header">
                                <h3 class="box-title">Deskripsi Kupon</h3>
                            </div>
                            <div class="box-body">

                                <textarea id="ckeditor" name="desk" required></textarea>
                    ...
                    <div class="col-md-4">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Kupon Code</h3>
                            </div>
                            <div class="box-body">
                    ...
                    <div class="col-md-4">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Jumlah % Diskon</h3>
                            </div>
                            <div class="box-body">

                                <div class="form-group">

                                    <input type="number" class="form-control" name="jml_diskon" required>
                                </div>
                                <!-- /.form group -->
                    ...
                    <div class="col-md-4">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Valid Until</h3>
                            </div>
                            <div class="box-body">

                                <div class="form-group">
                                    <input name="valid_until" id="datepicker4" value="" class="form-control" type="text" placeholder="Valid Until" required>
                                </div>
                                <!-- /.form group -->
